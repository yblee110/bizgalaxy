...
const config: Config = {
  ...
  theme: {
    extend: {
      colors: {
        // Deep Cosmos Color Palette
        background: "hsl(var(--background))", // Void Black #030712
        foreground: "hsl(var(--foreground))", // White Dwarf #F9FAFB
        primary: {
          DEFAULT: "hsl(var(--primary))", // Nebula Violet #7C3AED
          foreground: "hsl(var(--primary-foreground))",
        },
        secondary: {
          DEFAULT: "hsl(var(--secondary))", // Orbit Cyan #06B6D4
        ...
        accent: {
          DEFAULT: "hsl(var(--accent))", // Supernova Pink #EC4899
          foreground: "hsl(var(--accent-foreground))",
        },
        muted: {
          DEFAULT: "hsl(var(--muted))", // Space Dust #6B7280
